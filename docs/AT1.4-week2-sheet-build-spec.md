...
**Why this matters:** these are the four details a reviewer will look for first, because they're the actual evidence the hybrid was engineered, not just diagrammed.
...
**Footer refs:** AT1.4 Structural System Report §5. Timber Fire Safety in Construction; NACHI, lateral load connection reference.
...
| Grid study | Finding |
|---|---|
| Single span (no secondary beam) | Cost rises linearly with span |
| Square bay + 1 secondary beam | Cost-optimum near **~7.3 m** |
| Stepped grid | Cheapest at smaller grids, shorter beam spans |

**Why this matters:** "6.0 m" isn't a template assumption — it's the number where CLT's structural limit and the published cost-optimum both land close together.
**Takeaway:** *When asked "why this span," the answer is two independent data sets that happen to agree, not a single justification.*

**Diagram:** CLT span-by-ply chart + cost-per-m² vs. grid-spacing curve with the optimum marked and 6.0 m annotated.
...
| 4. Timber tower | Storey-by-storey platform erection, dry | Fast — pre-cut, small crew |
| 5. Envelope/fit-out | Follows a few storeys behind erection | Not waiting on concrete cure times |

**Why this matters:** the claim "hybrid mass timber is faster to build" only holds for the tower, not the whole building — stating this precisely is what makes it hold up under questioning.
**Takeaway:** *The real, provable speed claim is "the podium is normal speed, the tower above is dramatically faster" — Brock Commons' 70-day timber erection is the number that backs it up.*
...
| Pathway | What it offers this project |
|---|---|
| Supply Nation certification | Verifies ≥51% Indigenous ownership/management/control |
| Tiwi Forestry Project (NT) | Indigenous-led commercial forestry, export scale |
| Intract Indigenous Contractors | 51% Indigenous-owned civil construction delivery |
| Gambarra Building Supplies | Indigenous-owned materials supplier — certification to be verified |
| Wurundjeri Woi-wurrung engagement | Material/landscape decision input — not yet formalised, flagged as next step |

**Why this matters:** on Wurundjeri Country, procurement and cultural engagement belong at schematic design, the same stage the structural hybrid itself was decided.
**Takeaway:** *The honest line to present: "we don't yet have an Indigenous-owned mass timber mill in the supply chain, but here's where Indigenous-owned businesses can be engaged today, and here's the Traditional Owner engagement this project would need before it's real."*
...
**Footer refs:** AT1.4 Structural System Report §8. Supply Nation; FWPA, *Indigenous Owned and Managed Forests*; ArchitectureAU, *Aboriginal bush materials in contemporary architecture*.
...
|---|---|---|
| Class 3 (A6G4) | Long-term/transient accommodation, unrelated occupants | Shared kitchen 120–150 m², studios 15–25 m² ensuite |
...
**Why this matters:** the Class 2 vs. Class 3 distinction changes almost every downstream requirement — getting it right here is what makes every later compliance sheet valid.
...
### Sheet 17 — Classification consequences

**Narrative:** Once Class 3 is established (Sheet 16), it triggers a specific set of downstream requirements. Class 3 accommodation houses unrelated occupants, which triggers stricter fire and egress requirements than a Class 2 apartment building. The practical outcome: **the RC podium and timber tower hybrid only satisfies the NCC if the fire strategy behind it is actually demonstrated on the drawings.**
...
| AS 1428.1 | DDA 1:20 on Class 3 floors | Sheet 20 |

**Why this matters:** this sheet is the map showing every later compliance sheet answers a requirement generated here.
**Takeaway:** *Every fire, escape, and access decision in the following sheets traces back to one classification decision on Sheet 16.*
...
**Why this matters:** because the stairs live inside the RC core, this sheet is proof the structural system and fire-egress strategy weren't designed separately and then reconciled.
**Takeaway:** *The two stairs aren't placed for code compliance after the fact — they're literally inside the concrete core Sheet 01 already located for structural reasons.*

**Diagram:** Typical floor — core, 2 stairs, dashed travel paths, max distance annotated, drawn on the 6.0 m grid.
**Footer refs:** ABCB, *NCC 2022*, D1/D1.4. RMIT Brief (10% fire).

---

### Sheet 19 — Fire resistance & timber (Section C + Part B1)

**Narrative:** The structure has to remain standing for the full duration of the escape strategy on Sheet 18. Five measures layer together: compartmentation storey by storey; sprinklers throughout Class 3 floors; an FRL applied to the structure and the Class 3/6 separation; and, specifically for the exposed CLT and glulam, an **encapsulation or char-design approach** — sizing a sacrificial outer layer into the panel or beam thickness itself, rather than boxing the timber in plasterboard. The RC podium naturally satisfies the fire separation at the retail/transfer level without extra linings — one more reason Hybrid B was chosen.
...
### Sheet 20 — F2/sanitary, wet areas, DDA-accessible studio

**Narrative:** Drawn on the same 6.0 m structural grid used throughout — the DDA studio is a standard bay sized to the accessible standard, not a special-case room bolted onto the plan. Every studio needs an ensuite meeting NCC Tables F2.3/F2.4, alongside communal WC/basin provision; wet areas need waterproofing under Part 10.2. DDA-accessible studios need AS 1428.1: 30–35 m², 1:20 maximum gradient, clear door openings of at least 850 mm, and turning circles.
